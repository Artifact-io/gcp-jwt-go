...
Example:
	...
	func validateToken(ctx context.Context, tokenString string) (*jwt.Token, error) {
		...
		// This is basically copying the https://github.com/golang-jwt/jwt/blob/main/parser.go#L23 ParseWithClaims function here but forcing our own method vs getting one based on the Alg field
